...
type LoginServiceClient interface {
	ValidateLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}
...
type LoginServiceServer interface {
	ValidateLogin(context.Context, *LoginRequest) (*LoginResponse, error)
...
func (UnimplementedLoginServiceServer) ValidateLogin(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _LoginService_ValidateLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServiceServer).ValidateLogin(ctx, in)
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _LoginService_ValidateLogin_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "yamul-backend-login.proto",
}
